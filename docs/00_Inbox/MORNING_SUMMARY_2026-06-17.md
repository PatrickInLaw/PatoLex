...
## The headline
**The OCR historical corpus (1850–1999) is 92.5% complete (confident), biennium-correct** — up from a starting *measured* 87.6%, and the confusing "71% / ~20k missing" narrative was proven to be a **measurement artifact, not missing data**. Cumulative chapters recovered this run, **all Hans-gated and 0-duplicate**: certify **+3,213**, modern multi-engine **+3,413**, early-era roman multi-engine **+~1,224** (~7,850 total). Missing now 7,185.
